					...
					<div class="row">
						<section class="4u 6u(medium) 12u$(small)">
							...
							<ul class="alt">
								...
								<li><a href="https://jioganeshjio.com/">Code-Projects</a> </li>
							</ul>
						</section>
						<section class="4u 6u$(medium) 12u$(small)">
			...
			<!--				<ul class="icons">
					...
					-->		<ul class="tabular">
								<li>
									<h3>Address</h3>
									ABC Road<br>
									<a href="https://jioganeshjio/">Code-Projects</a> 204264
								</li>
								<li>
									<h3>Mail</h3>
									<a href="#">jioganeshjio@gmail.com</a>
								</li>
								<li>
									<h3>Phone</h3>
									+91-7488103516, +91-6205659678
								</li>
							</ul>
						</section>
					</center>
					...
					<ul class="copyright">
						<li>&copy; 2019 BookMyBusTicket. All rights reserved. Brought To You By <a href="https://www.facebook.com/onlinebikerentl/">Code-Projects</a></li>
			<!--			<li>Design: <a href="http://jioganeshjio.com">TEMPLATED</a></li>
						<li>Images: <a href="http://jioganeshjio.com">Unsplash</a></li>
				-->	</ul>
				</div>
			</footer>
